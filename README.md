...
Fan translations for Amanatsu Location, for use with [XUnity Auto Translator](https://github.com/bbepis/XUnity.AutoTranslator).

You can see which languages are supported [here](https://gitgoon.dev/IllusionMods/AmaLoca-Translation/tree/main/Translation).
...
3. Install This Translation
	- Download the latest release from the [Releases](https://gitgoon.dev/IllusionMods/AmaLoca-Translation/releases) page.
...
First get ReleaseTool from https://github.com/IllusionMods/Aicomi-Translation, then run ReleaseTool by dragging the repository folder onto it. The tool will generate a new release zip in the same folder as the executable.
